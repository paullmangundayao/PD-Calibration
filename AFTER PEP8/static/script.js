...
document.getElementById('initialSealButton').addEventListener('click', async () => {
    ...
    try {
        ...
        if (!feedResponse.ok) {
            throw new Error(feedResult.message || 'Feeding failed');
        }
        ...
        document.getElementById('confirmSeal').addEventListener('click', async function handler() {
            ...
            try {
                ...
                if (!sealResponse.ok) {
                    throw new Error(sealResult.message || 'Sealing failed');
                }
...
document.getElementById('detectButton').addEventListener('click', async () => {
    ...
    try {
        ...
        if (!response.ok) {
            throw new Error(
                'Failed to capture dimensions. Please check your camera or sensor setup.'
            );
        }
